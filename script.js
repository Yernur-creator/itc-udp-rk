...
const translations = {
  ...
  kz: {
    ...
    'tab-sak-name': 'ЖАК', 'tab-sak-desc': 'Жағдаяттық-аналитикалық кешен', 'tab-epir-name': 'ЕИАР', 'tab-epir-desc': 'Интернет-ресурстардың бірыңғай платформасы', 'tab-oss-name': 'ӘЖЖ', 'tab-oss-desc': 'Әлсіз ток жүйелерін қызмет көрсету', 'tab-tech-name': 'Техникалық қамтамасыз ету', 'tab-tech-desc': 'Ресми іс-шараларды техникалық қамтамасыз ету', 'tab-byuro-name': 'Өткізу бюросы', 'tab-byuro-desc': 'Цифрлық рұқсат жүйесі',
